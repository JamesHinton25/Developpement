...
if (_ownerID != getPlayerUID player) then {
    ...
    (CONTROL(2620,2624)) ctrlEnable false; //expulser
    (CONTROL(2620,2625)) ctrlEnable false; //nouveau chef
    (CONTROL(2620,2630)) ctrlEnable false; //inviter joueur
    (CONTROL(2620,2631)) ctrlEnable false; //dissoudre
};
