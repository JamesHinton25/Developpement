...
_fuelstations = nearestObjects [player, ["Land_FuelStation_01_pump_malevil_F"], 10];
...
ctrlSetText [20301,"Station Service"];
...
ctrlSetText [20323,format ["Prix : %1 $",life_fuelPrices * 0.1]];
