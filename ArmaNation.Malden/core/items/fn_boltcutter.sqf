...
if (((nearestObject [[9478.34,4175.56,0],"Land_Dome_Big_F"]) == _building || (nearestObject [[9478.34,4175.56,0],"Land_Research_house_V1_F"]) == _building) && (west countSide playableUnits < (LIFE_SETTINGS(getNumber,"minimum_cops")))) exitWith {
    hint parseText format [localize "STR_Civ_NotEnoughCops",(LIFE_SETTINGS(getNumber,"minimum_cops"))]
};
if ((typeOf _building) == "Land_Research_house_V1_F" && (nearestObject [[9478.34,4175.56,0],"Land_Dome_Big_F"]) getVariable ["locked",true]) exitWith {hint localize "STR_ISTR_Bolt_Exploit"};
...
if ((nearestObject [[9478.34,4175.56,0],"Land_Dome_Big_F"]) == _building || (nearestObject [[9478.34,4175.56,0],"Land_Research_house_V1_F"]) == _building) then {
