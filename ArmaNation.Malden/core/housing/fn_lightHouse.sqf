...
if (_mode) then {
    ...
    switch (true) do {
        ...
        case ((typeOf _house) in ["Land_i_House_Big_02_b_blue_F","Land_i_House_Big_02_b_pink_F","Land_i_House_Big_02_b_whiteblue_F","Land_i_House_Big_02_b_white_F","Land_i_House_Big_02_b_brown_F","Land_i_House_Big_02_b_yellow_F"]): {_lightSource lightAttachObject [_house,[2,0,3.5]];};
        case ((typeOf _house) in ["Land_i_House_Big_01_b_blue_F","Land_i_House_Big_01_b_pink_F","Land_i_House_Big_01_b_whiteblue_F","Land_i_House_Big_01_b_white_F","Land_i_House_Big_01_b_brown_F","Land_i_House_Big_01_b_yellow_F"]): {_lightSource lightAttachObject [_house,[0,-2,3.8]];};
        case ((typeOf _house) in ["Land_i_House_Small_01_b_blue_F","Land_i_House_Small_01_b_pink_F"]): {_lightSource lightAttachObject [_house,[-1.5,0,2]];};
        case ((typeOf _house) in ["Land_i_House_Small_02_b_blue_F","Land_i_House_Small_02_b_pink_F","Land_i_House_Small_02_b_whiteblue_F","Land_i_House_Small_02_b_white_F","Land_i_House_Small_02_b_brown_F","Land_i_House_Small_02_b_yellow_F"]): {_lightSource lightAttachObject [_house,[2,0,2.4]];};
        default {_exit = true;};
    };
