...
class CfgRemoteExec {
    class Functions {
        ...
        F(life_fnc_robStations,CLIENT)
        F(life_fnc_brinks,CLIENT)
        ...
        F(life_fnc_ticketUPaid,CLIENT)
        F(life_fnc_ticketUPrompt,CLIENT)
        F(life_fnc_vehicleAnimate,CLIENT)
        F(life_fnc_wantedList,CLIENT)
        F(life_fnc_wireTransfer,CLIENT)
        F(life_fnc_copBackup,CLIENT)
        F(life_fnc_copBackupCalled,CLIENT)
        F(life_fnc_informateur,CLIENT)
        F(life_fnc_copSeize,CLIENT)
        ...
        F(TON_fnc_cell_taxirequest,CLIENT)
        ...
        F(life_fnc_illegalMarket,ANYONE)
