...
[] call compile PreprocessFileLineNumbers "core\server\clientValidator.sqf";
enableSentences false;

//Setup initial client core functions
diag_log "::Life Client:: Initialization Variables";
[] call compile PreprocessFileLineNumbers "core\server\configuration.sqf";
...
if (LIFE_SETTINGS(getNumber,"pump_service") isEqualTo 1) then{
    [] execVM "core\server\fn_setupStationService.sqf";
};
