...
if (_value < 100 && BANK > 20000000) exitWith {hint parseText localize "STR_ATM_WithdrawMin"}; //Temp fix for something.

CASH = CASH + _value;
BANK = BANK - _value;
hint parseText format [localize "STR_ATM_WithdrawSuccess",[_value] call life_fnc_numberText];
