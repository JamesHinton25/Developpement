...
class playerSettings
{
    ...
    class controls {
        ...
        class ButtonCopMenu: Life_RscButtonMenu {
            idc = 2017;
            text = "$STR_PM_CopMenu";
            //onButtonClick = "createDialog ""life_cop_menu"";";
            onButtonClick = " hint 'Ce module est en cours de développement.'; ";
            x = 0.1 + (6.25 / 40) + (1 / 250 / (safezoneW / safezoneH));
            y = 0.805;
            w = (6.25 / 40);
            h = (1 / 25);
        ...
        class ButtonBrinksMenu: Life_RscButtonMenu {
            idc = 2019;
            text = "$STR_PM_BrinksMenu";
            onButtonClick = "[] spawn life_fnc_brinksInteractionMenu; closeDialog 0;";
            x = 0.1 + (6.25 / 40) + (1 / 250 / (safezoneW / safezoneH));
            y = 0.805;
            w = (6.25 / 40);
            h = (1 / 25);
