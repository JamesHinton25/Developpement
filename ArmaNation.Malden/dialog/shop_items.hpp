class shops_menu {
    ...
    class controlsBackground {
        ...
        //(refonte en cours) class MoldusMenuPicture: Life_RscPicture { idc = -1; text = "icons\hud\menu.paa"; x = 0.075; y = -0.1; w = 0.85; h = 0.76; };
        ...
        class MainBackground: Life_RscText {
            ...
            w = 0.8;
            h = 0.6 - (22 / 250);
            //(refonte en cours) x = 0.0875; y = 0.236; w = 0.825; h = 0.52;
        };
    ...
    class controls {
        ...
        class ButtonClose: Life_RscButtonMenu {
            ...
            w = (6.25 / 40);
            h = (1 / 25);
            //(refonte en cours)x = 0.0875; y = 0.76; w = 0.15625 h = 0.04;
        };
    };
};